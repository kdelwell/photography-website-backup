      ...
      <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-6">
          ...
          <div className="grid grid-cols-2 gap-x-12 gap-y-1 text-sm text-white mt-2 md:mt-4 text-center md:text-left">
            ...
            <Link href="/prep" className="hover:text-red-500 transition-colors">Prep Tips</Link>
            <Link href="/sms-consent" className="hover:text-red-500 transition-colors">SMS Consent</Link>
          </div>
          ...
          <div className="text-center md:text-right text-sm">
            ...
            <div>
              <a href="tel:703-802-9379" className="text-white hover:text-red-500 transition-colors">703-802-9379</a>
            </div>
          </div>
        </div>
