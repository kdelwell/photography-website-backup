  ...
  const faqSchema = {
    ...
    "mainEntity": [
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Professional headshot sessions in Northern Virginia typically range from $375-$700 depending on the package, number of looks, and turnaround time. Because we're based in NoVA, there are no travel fees for locations throughout the region. Same-day delivery is available."
        }
      },
      {
        "@type": "Question",
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-700">
                Professional headshot sessions in Northern Virginia typically range from $375-$700 depending on
