  ...
  const faqSchema = {
    ...
    "mainEntity": [
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Business headshot sessions in Centreville typically range from $375-$700 depending on the package, number of looks, and turnaround time. We offer competitive pricing with same-day delivery options."
        }
      },
      {
        "@type": "Question",
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-700">
                Business headshot sessions in Centreville typically range from $375-$700 depending on the package,
