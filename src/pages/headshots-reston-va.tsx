    ...
    "mainEntity": [
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Get aHead Shot serves Reston, VA including Reston Town Center, Lake Anne, South Reston, North Reston, and the Dulles Corridor. We bring our full professional studio setup to your office or any location."
        }
      },
      {
        "@type": "Question",
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Professional headshot sessions in the Reston area typically range from $375-$700. Pricing depends on the package, number of final images, and turnaround time. Same-day rush delivery is available."
        }
      },
      {
        "@type": "Question",
          ...
          <div className="space-y-6">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-700">
                Get aHead Shot serves Reston, VA including Reston Town Center, Lake Anne, South Reston,
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-700">
                Professional headshot sessions in the Reston area typically range from $375-$700. Pricing depends on the
